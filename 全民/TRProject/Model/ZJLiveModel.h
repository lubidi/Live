...
@class LiveRecommendModel,LiveRecommendDataModel,LiveRecommendDataLink_ObjectModel,LiveDataModel;
...
@property (nonatomic, strong) NSArray<LiveRecommendDataModel *> *data;
...
@property (nonatomic, strong) LiveRecommendDataLink_ObjectModel *link_object;
...
@interface LiveRecommendDataLink_ObjectModel : NSObject
